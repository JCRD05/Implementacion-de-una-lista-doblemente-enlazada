...
class Program 
{
    ...
    static void Operations(list lista, int opt)
    {
        ...
        switch(opt)
        {
            ...
            case 6: 
                ...
                break;
            default: 
                Console.WriteLine("Elija una opcion entre 1 y 6"); // Mensaje de error en caso de opción inválida
                break;
        }
    }
	...
	static void Main() 
	{
        ...
        } while (Exit() && (opt > 0 && opt < 7)); // Repite mientras el usuario quiera continuar y la opción sea válida
	}
}