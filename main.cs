...
class Program 
{
    ...
    static void Operations(list lista, int opt)
    {
        ...
        switch(opt)
        {
            ...
            case 7: // Inserta un elemento a un punto dado de la lista
                Console.WriteLine("Introduzca el texto que desea meter en el punto dado de la lista\n");
                data = Console.ReadLine();
                Console.WriteLine("¿En que posicion lo quiere colocar?\n");
                index = Convert.ToInt32(Console.ReadLine());
                lista.Insert(data, index);
                break;
            case 8: // Borra un elemento de un punto dado de la lista
                Console.WriteLine("¿En que posicion quiere eliminar el dato?\n");
                index = Convert.ToInt32(Console.ReadLine());
                lista.Delete(index);
                break;
            case 9:
                ...
                break;
            default: 
                Console.WriteLine("Elija una opcion entre 1 y 8"); // Mensaje de error en caso de opción inválida
                break;
        }
    }
	...
	static void Main() 
	{
        ...
        do
        {
            ...
            Console.WriteLine("8. Borrar un elemento\n");
